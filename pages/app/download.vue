      ...
      <section class="banner">
        <section class="container">
          <div class="bd">
            ...
            <div class="title">
              <h1>天翼云瞰</h1>
              <h2 class="mt-10">天翼云智能视图服务客户端</h2>
            </div>
            <div class="use-help">
              <h5>首次使用指引：</h5>
              <p>1、注册天翼云账号并开通天翼云智能视图服务。</p>
              <p>2、点击下方的客户端链接完成下载并安装客户端。</p>
              <p>
                3、输入天翼云智能视图服务登录账号或邮箱以及设置的密码，开始使用天翼云瞰软件。
              </p>
            </div>
          </div>
          ...
          <section class="download">
            ...
            <div class="downloadBox">
              ...
              <div class="btns">
                <button>
                  <a href="https://apps.apple.com/cn/app/天翼云瞰/id1609919930"
                    >立即下载</a
                  >
                </button>
              </div>
...
export default Vue.extend({
  ...
  methods: {
    isMobileBrowser() {
      return this.detectMobileBrowser(
    ...
    isqq() {
      return (
        navigator.userAgent.indexOf('YYB_D ') > -1 ||
