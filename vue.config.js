...
const name = '天翼云视频云网平台-运营控制台'
const serverAddressMapping = {
  local: 'http://172.24.6.26:8081', // 本地环境
  // local: 'http://172.24.6.22:8081', // 本地环境
  dev: 'http://182.43.127.35:9190', // 开发环境
  // dev: 'http://172.24.6.22:8081', // 开发环境
  // dev: 'http://172.24.9.39:8081',
  test: 'http://182.43.127.35:9080', // 测试环境
  prod: 'http://182.43.127.43:9180' // 生产环境
}
const portMapping = {
  local: 9180,
  dev: 9190,
...
module.exports = {
  publicPath: process.env.NODE_ENV === 'production' ? '/vss-operation/' : '/',
